                ...
                <div className="container">
                    ...
                    <div className="tab-2-content-bottom">
                        <div>
                            ...
                            <p className="text-dark">Smart TVs,Playstation,Chromecast,Blu-ray players,Apple and More</p>
                        </div>
                   <div>
                        <img src="https://i.ibb.co/R3r1SPX/tab-content-2-2.png" alt="" />
                        <p className="text-md">Watch instantly or download for later</p>
                        <p className="text-dark">Available on phone,tablet,wherever you go</p>    
                    </div>
                    <div>
            ...
            <section className="tab-content">
                <div className="container">
                    ...
                    activeTabName===PICK_YOUR_PRICE && "show"}`}>
                        ...
                        <tbody>
                            <tr>
                                <td>Monthly Price after free month ends on 19/10/2021</td>
                                <td>INR 440</td>
                                <td>INR 770</td>
                                <td>INR 1000</td>
                            </tr>
